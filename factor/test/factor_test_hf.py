...
class HFRtnMoment(HFFactor):
    ...
    def _daily_process(self):
        ...
        daily_mean, daily_std, daily_skew, daily_kurt = self.t_daily_factor(open_comm_list)

        self.mean.append(daily_mean)
        self.std.append(daily_std)
        self.skew.append(daily_skew)
        self.kurt.append(daily_kurt)
