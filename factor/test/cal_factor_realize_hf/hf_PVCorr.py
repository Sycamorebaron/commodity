...
def hf_PVCorr(begin_date='2010-01-04', end_date='2021-02-28'):
    ...
    P1V0.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'P1V0.csv'))
    P2V0.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'P2V0.csv'))
    P3V0.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'P3V0.csv'))
    P0V1.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'P0V1.csv'))
    P0V2.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'P0V2.csv'))
    P0V3.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'P0V3.csv'))

    R1DV0.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'R1DV0.csv'))
    R2DV0.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'R2DV0.csv'))
    R3DV0.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'R3DV0.csv'))
    R0DV1.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'R0DV1.csv'))
    R0DV2.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'R0DV2.csv'))
    R0DV3.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'R0DV3.csv'))
