...
from factor.test.factor_test_hf import HFUpDownFactor
...
def hf_up_down(begin_date='2010-01-04', end_date='2021-02-28'):
    ...
    up_rtn_mean.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'up_rtn_mean.csv'))
    up_rtn_std.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'up_rtn_std.csv'))
    up_move_vol_pct.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'up_move_vol_pct.csv'))
    up_vol_pct.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'up_vol_pct.csv'))
    down_rtn_mean.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'down_rtn_mean.csv'))
    down_rtn_std.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'down_rtn_std.csv'))
    down_move_vol_pct.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'down_move_vol_pct.csv'))
    down_vol_pct.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'down_vol_pct.csv'))
    trend_ratio.to_csv(os.path.join(OUTPUT_DATA_PATH, 'HFfactor', 'trend_ratio.csv'))
