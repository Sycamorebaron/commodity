import pandas as pd
import os
from utils.base_para import HF_COMM_FACTOR_DATA_PATH, local_hf_factor_path, NORMAL_CONTRACT_INFO
...
if __name__ == '__main__':
    rtn_data = pd.read_csv(os.path.join(local_hf_factor_path, 'hf_rtn.csv'))
    ...
    for comm_info in NORMAL_CONTRACT_INFO:
        ...
        comm_factor_data.to_csv(os.path.join(HF_COMM_FACTOR_DATA_PATH, '%s.csv' % commodity))
