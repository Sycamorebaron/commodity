    ...
    def execute(self, X):
        ...
        for node in self.program:
            ...
            while len(apply_stack[-1]) == apply_stack[-1][0].arity + 1:
                ...
                # 【修改】<存在无法进行的可能性，发生变异后，该函数可能无法执行，如应该传入array的地方变异成了int，跳过这些变异>
                try:
                    intermediate_result = function(*terminals)
                    # print('function 386', '>' * 50)
                    # print('function', function, function.name)
                    ...
                    return None
                # </在无法进行的可能性，发生变异后，该函数可能无法执行，如应该传入array的地方变异成了int，跳过这些变异>
